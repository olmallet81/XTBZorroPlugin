...
XTB offers free access to their API. The connection is made through TCP sockets. Link to API documentation: http://developers.xstore.pro/documentation/#introduction.
